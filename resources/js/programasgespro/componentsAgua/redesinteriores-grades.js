...
export function initRedesInterioresModule() {
    ...
    redesInteriores.innerHTML = `
        <div x-data="redesInterioresModule" class="w-full p-4">
            <!-- Header Principal -->
    ...
    Alpine.data('redesInterioresModule', () => ({
...
//document.addEventListener('DOMContentLoaded', initRedesInterioresModule);