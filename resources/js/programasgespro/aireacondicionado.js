    ...
    methods: {
        ...
        getSheetTotal(sheet) {
            try {
                ...
                const totalLoad = areaLoad + thermalLoad;
        ...
        getTotalUnits(sheet) {
            return sheet.acTypes.reduce((sum, ac) => sum + (parseFloat(ac.quantity) || 1), 0);
        },
