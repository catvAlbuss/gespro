<x-app-layout>
        ...
        @if (Auth::check())
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div id="mobile-auto-indicator" class="hidden md:hidden">
                    <div class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg text-white text-sm font-medium shadow-lg">
    ...
    <div id="dashboard-app" class="py-8">
        <!-- Pantalla de carga inicial para móviles -->
        <div id="mobile-loading-screen" class="hidden fixed inset-0 z-50 bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600">
            <div class="flex flex-col items-center justify-center h-full px-6">
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full mb-6 shadow-2xl">
                        <svg class="w-12 h-12 text-cyan-600 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                ...
                <div class="w-full max-w-md space-y-4">
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
                        ...
                        <div class="w-full bg-white bg-opacity-30 rounded-full h-2">
                            <div id="location-progress" class="bg-green-400 h-2 rounded-full transition-all duration-500" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
                        ...
                        <div class="w-full bg-white bg-opacity-30 rounded-full h-2">
                            <div id="camera-progress" class="bg-green-400 h-2 rounded-full transition-all duration-500" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
                        ...
                        <div class="w-full bg-white bg-opacity-30 rounded-full h-2">
                            <div id="tasks-progress" class="bg-green-400 h-2 rounded-full transition-all duration-500" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500 transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Asistencias</p>
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2" id="stat-asistencias">--</p>
                        </div>
                ...
                <!-- Card: Tardanzas -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Tardanzas</p>
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2" id="stat-tardanzas">--</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500 transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <!-- Card: Progreso -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500 transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Progreso</p>
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2" id="stat-progreso">--%</p>
                        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Calendario de Actividades</h3>
                        </div>
                        <div class="p-6">
    ...
    <div id="modal-asistencia" class="hidden fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="px-6 py-6">
                    <!-- Estado del escáner -->
                    <div id="qr-status" class="mb-4 p-4 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900 dark:to-cyan-900 border-2 border-blue-200 dark:border-blue-700">
                    ...
                    <div id="queue-info" class="hidden mb-4 p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700">
                    ...
                    <div id="qr-reader" class="rounded-lg overflow-hidden border-4 border-dashed border-gray-300 dark:border-gray-600 shadow-inner"></div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900 px-6 py-4">
                    <button id="btn-cancelar-escaneo" class="w-full px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
                        Cancelar
                    </button>
                </div>
            </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 px-6 py-4 flex items-center justify-between">
                    ...
                    <button id="btn-cerrar-tareas" class="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all">
                        Cerrar
                    </button>
                </div>
            </div>
