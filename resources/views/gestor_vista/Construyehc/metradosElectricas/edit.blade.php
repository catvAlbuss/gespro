<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Editar Metrados Electricos') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
            <h2 class="text-xl font-bold mb-4">Editar Metrado Eléctrico</h2>
            ...
            <form action="{{ route('metradoelectricas.update', $metrado->idmeelectrica) }}" method="POST">
                @csrf
                @method('PUT')
