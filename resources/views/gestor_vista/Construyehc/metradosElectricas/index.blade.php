                                ...
                                @foreach ($metradoelectricas as $metrado)
                                    <tr
                                        ...
                                        <td class="px-4 py-2 font-medium text-gray-900  dark:text-white">
                                            {{ $metrado->modulo }}</td>
                                        <td class="px-4 py-2 font-medium text-gray-900  dark:text-white">
                                            <a href="{{route('metradoelectricas.show', $metrado->idmeelectrica)}}" class="btn text-blue-500">Visualizar</a>
                                        </td>
                                        <td class="px-4 py-2 font-medium text-gray-900 dark:text-white">
                                            <a href="{{ route('metradoelectricas.edit', $metrado->idmeelectrica) }}" class="btn text-yellow-500">Editar</a>
                                        </td>
                                        <td class="px-4 py-2">
                                            <form
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" action="{{ route('metradoelectricas.store') }}">
                    @csrf
