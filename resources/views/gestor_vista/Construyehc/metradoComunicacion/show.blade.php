<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                ...
                {{ __('Gestión Metrados Comunicación') }}
            </h2>
    ...
    <!-- Inputs ocultos con datos del metrado -->
    ...
    <input type="hidden" name="idmetradocomunicacion" id="idmetradocomunicacion"
        value="{{ $metradocomunicaciones->idmetradocomunicacion }}">
    <input type="hidden" name="nombre_proyecto" id="nombre_proyecto"
        value="{{ $metradocomunicaciones->nombre_proyecto }}">
    <input type="hidden" name="cui" id="cui" value="{{ $metradocomunicaciones->codigocui }}">
    <input type="hidden" name="codigo_modular" id="codigo_modular"
        value="{{ $metradocomunicaciones->codigo_modular }}">
    ...
    <input type="hidden" name="unidad_ejecutora" id="unidad_ejecutora"
        value="{{ $metradocomunicaciones->unidad_ejecutora }}">
    ...
    <input type="hidden" name="localidad" id="localidad" value="{{ $metradocomunicaciones->ubicacion }}">
                ...
                <div class="space-y-6">
                    <div>
                        <h3 class="text-gray-800 dark:text-gray-200 text-xl font-semibold mb-4 flex items-center">
                            ...
                            Metrados de Comunicación
                        </h3>
                        <div class="overflow-x-auto border rounded-lg" id="metrados-comunicacion-table"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="overflow-x-auto border rounded-lg" id="metrados-comunicacion-resumen"></div>
                    </div>
                </div>
            </div>
        </div>
