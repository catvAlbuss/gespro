                    ...
                    <div
                        ...
                        <div
                            ...
                            <button type="button" id="agregar_ms" data-modal-target="crud-modal"
                                ...
                                Agregar Metrados Comunicaciones
                            </button>
                        </div>
                    </div>
                                ...
                                @foreach ($metradocomunicaciones as $metrado)
                                    <tr
                                        ...
                                        <td class="px-4 py-2 font-medium text-gray-900  dark:text-white">
                                            {{ $metrado->modulo }}</td>
                                        <td class="px-4 py-2 font-medium text-gray-900  dark:text-white">
                                            <a href="{{route('metradocomunicacion.show', $metrado->idmetradocomunicacion)}}" class="btn text-blue-500">Visualizar</a>
                                        </td>
                                        <td class="px-4 py-2 font-medium text-gray-900 dark:text-white">
                                            <a href="{{ route('metradocomunicacion.edit', $metrado->idmetradocomunicacion) }}" class="btn text-yellow-500">Editar</a>
                                        </td>
                                        <td class="px-4 py-2">
                                            <form
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        Registrar Metrados Comunicaciones
                    </h3>
                    <button type="button"
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" action="{{ route('metradocomunicacion.store') }}">
                    @csrf
