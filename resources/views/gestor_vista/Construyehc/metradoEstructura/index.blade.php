<x-app-layout>
                                    ...
                                    <tr class="hover:bg-gray-950 dark:hover:bg-gray-750 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-3">
                                                <a href="{{ route('metrados.estructuras.show', $metrado->idmetradoestructuras) }}"
                                                ...
                                                <button
                                                    onclick="openModal('edit', {{ $metrado->idmetradoestructuras }})"
                                                ...
                                                <form
                                                    action="{{ route('metrados.estructuras.destroy', $metrado->idmetradoestructuras) }}"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <h3 id="modal-title" class="ml-3 text-xl font-bold text-gray-900 dark:text-gray-100">
                                Registrar Metrado de Estructuras
                            </h3>
                        </div>
    ...
    <script>
        ...
        function loadMetradoData(id) {
            ...
            fetch(`{{ url('metrados.estructuras') }}/${id}`, {
                    method: 'GET',
                    headers: {
        ...
        function handleSubmit(event) {
            ...
            if (currentMode === 'create') {
                url = "{{ route('metrados.estructuras.store') }}";
                method = 'POST';
            } else if (currentMode === 'edit') {
                url = `{{ url('metrados.estructuras') }}/${currentId}`;
                method = 'PUT';
            }
