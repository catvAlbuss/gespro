                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="overflow-x-auto">
                            <h3 class="text-gray-950 dark:text-gray-50">Diseño</h3>
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            Diseño Sanitarias</th>
                                        <td class="px-6 py-4">Diseño</td>
                        ...
                        <div class="overflow-x-auto">
                            <h3 class="text-gray-950 dark:text-gray-50">ETERNIT</h3>
                            <table class="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead
                                    class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                        ...
                        <!--Prespuestos Acu -->
                        <div class="overflow-x-auto">
                            <h3 class="text-gray-950 dark:text-gray-50">Presupuestos - ACU</h3>
                            <table class="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead
                                    class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            Presupuestos Generales</th>
                                        <td class="px-6 py-4">Presupuestos</td>
                                        <td class="px-6 py-4">Construye</td>
                                        <td class="px-6 py-4">
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            Especificaciones Tecnicas</th>
                                        <td class="px-6 py-4">ETTP</td>
                                        <td class="px-6 py-4">Construye</td>
                                        <td class="px-6 py-4">
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            Cronograma Generales</th>
                                        <td class="px-6 py-4">Cronograma</td>
                                        <td class="px-6 py-4">Construye</td>
                                        <td class="px-6 py-4">
