<x-app-layout>
                                    ...
                                    <tr class="hover:bg-gray-950 dark:hover:bg-gray-750 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                <button onclick="openModal('edit', {{ $metrado->idmetradosan }})"
                    ...
                    @if ($metradosanitarias->count() === 0)
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-gray-500 dark:text-gray-400">Comienza agregando un nuevo metrado de
                                Electricas</p>
                            <div class="mt-6">
                                <button onclick="openModal('create')" data-modal-target="crud-modal"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <h3 id="modal-title" class="ml-3 text-xl font-bold text-gray-900 dark:text-gray-100">
                                Registrar Metrado de Electricas
                            </h3>
                        </div>
                ...
                <form id="metrado-form" class="bg-white dark:bg-gray-800" onsubmit="handleSubmit(event)">
                    ...
                    <div class="px-6 py-4 max-h-96 overflow-y-auto">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <!-- Cantidad de Modulo (Input simple) -->
                            <div>
                                <label for="cantidadModulo"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    Cantidad de Modulos <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="cantidadModulo" id="cantidadModulo" required
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
                                    placeholder="Ej: CL-001234">
                            </div>
    ...
    <script>
        ...
        function openModal(mode, id = null) {
            ...
            if (mode === 'create') {
                modalTitle.textContent = 'Registrar Metrado de Electricas';
                ...
                modalTitle.textContent = 'Editar Metrado de Ekectricas';
        ...
        // Función para manejar los checkboxes de nivel educativo
        ...
        function loadMetradoData(id) {
            ...
            fetch(`{{ url('metradosanitarias') }}/${id}`, {
                ...
                .then(data => {
                    ...
                    document.getElementById('cantidadModulo').value = data.cantidadModulo || '';
        ...
        function handleSubmit(event) {
            ...
            const nivelesEducativos = formData.getAll('nivel_educativo[]');
            ...
            // Construir objeto codigo_modular
            const codigoModular = {};
            ...
            const data = {
                ...
                codigo_local: formData.get('codigo_local'), // ahora es input simple
                codigo_modular: JSON.stringify(codigoModular),
                especialidad: formData.get('especialidad'),
                fecha: formData.get('fecha'),
                ubicacion: formData.get('ubicacion'),
                cantidadModulo: formData.get('cantidadModulo'),
