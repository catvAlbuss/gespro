<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                ...
                {{ __('Gestión Metrados Sanitarias') }}
            </h2>

            <!-- Botones de acción -->
            <div class="flex flex-wrap items-center gap-2">
                <div class="flex items-center gap-2">
                    <label for="modules" class="text-gray-950 text-sm dark:text-white">Número de Módulos:</label>
                    <input
                        class="text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-12 text-center"
                        type="number" name="modules" id="modules" value="{{ $metradosanitarias->cantidadModulo }}"
    ...
    <input type="hidden" name="idmetradosan " id="idmetradosan" value="{{ $metradosanitarias->idmeelectrica }}">
    <input type="hidden" name="nombre_proyecto" id="nombre_proyecto" value="{{ $metradosanitarias->nombre_proyecto }}">
    <input type="hidden" name="unidad_ejecutora" id="unidad_ejecutora"
        value="{{ $metradosanitarias->unidad_ejecutora }}">
    <input type="hidden" name="cui" id="cui" value="{{ $metradosanitarias->codigocui }}">
    <input type="hidden" name="codigo_modular" id="codigo_modular" value="{{ $metradosanitarias->codigo_modular }}">
    <input type="hidden" name="codigo_local" id="codigo_local" value="{{ $metradosanitarias->codigo_local }}">
    <input type="hidden" name="unidad_ejecutora" id="unidad_ejecutora"
        value="{{ $metradosanitarias->unidad_ejecutora }}">
    <input type="hidden" name="fecha" id="fecha" value="{{ $metradosanitarias->fecha }}">
    <input type="hidden" name="especialidad" id="especialidad" value="{{ $metradosanitarias->especialidad }}">
    <input type="hidden" name="localidad" id="localidad" value="{{ $metradosanitarias->ubicacion }}">
            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="overflow-x-auto border rounded-lg" id="modulos"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="overflow-x-auto border rounded-lg" id="exterior"></div>
                    </div>

                    <div>
                        <h3 class="text-gray-800 dark:text-gray-200 text-xl font-semibold mb-4 flex items-center">
                            <i class="fas fa-table text-blue-600 mr-2"></i>
                            Metrados Cisterna y TE
                        </h3>
                        <div class="overflow-x-auto border rounded-lg" id="cisternate"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="overflow-x-auto border rounded-lg" id="resumen"></div>
                    </div>
                </div>
            </div>
        </div>
