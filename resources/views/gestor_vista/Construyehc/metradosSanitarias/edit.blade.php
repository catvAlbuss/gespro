<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Editar Metrados Sanitarias') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
            <h2 class="text-xl font-bold mb-4">Editar Metrado Sanitarias</h2>
            ...
            <form action="{{ route('metradosanitarias.update', $metrado->idmetradosan) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="cui" value="{{ old('cui', $metrado->cui) }}"
                        class="w-full p-2 border rounded">
                    @error('cui')
                        <small class="text-red-500">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="codigo_modular" value="{{ old('codigo_modular', $metrado->cui) }}"
                        class="w-full p-2 border rounded">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="codigo_local" value="{{ old('codigo_local', $metrado->cui) }}"
                        class="w-full p-2 border rounded">
                    @error('codigo_local')
                        <small class="text-red-500">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="unidad_ejecutora" value="{{ old('unidad_ejecutora', $metrado->cui) }}"
                        class="w-full p-2 border rounded">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700">Cantidad Modulo</label>
                    <input type="number" name="cantidadModulo" value="{{ old('cantidadModulo', $metrado->cantidadModulo) }}"
                        class="w-full p-2 border rounded">
                    @error('cantidadModulo')
                        <small class="text-red-500">{{ $message }}</small>
                    @enderror
                </div>
