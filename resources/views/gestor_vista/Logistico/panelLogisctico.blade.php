<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center mt-4 space-x-2 py-2">
            ...
            <button id="abrir-tareas-trabs" type="button"
                class="relative py-1 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50">
                Tareas
    ...
    <script>
        ...
        document.getElementById('abrir-tareas-trabs').onclick = function() {
