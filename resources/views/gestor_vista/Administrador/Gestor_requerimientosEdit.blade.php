<x-app-layout>
    ...
    <div id="updateModal" class="fixed inset-0 flex items-center justify-center z-50 hidden bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <form id="updateForm" method="POST"
                ...
                <div class="space-y-4">
                    <div>
                        <label for="descripcion_manoobra"
                    ...
                    <div>
                        <label for="cantidad_manoobra"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Cantidad</label>
                        <input type="number" name="cantidad_manoobra" id="modal_cantidad_manoobra"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="precio_uni_manoobra"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Precio Unitario</label>
                        <input type="number" name="precio_uni_manoobra" id="modal_precio_uni_manoobra" step="any"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                </div>
    ...
    <div id="updateMaterialModal"
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <form id="updateMaterialForm" method="POST"
                ...
                <div class="space-y-4">
                    <div>
                        <label for="descripcion_material_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Descripción</label>
                    ...
                    <div>
                        <label for="unidad"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Unidad</label>
                        <input type="text" name="unidad" id="modal_unidad"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="cantidad_material_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Cantidad</label>
                        <input type="number" name="cantidad_material_req" id="modal_cantidad_material"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="precio_unitario_matreq"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Precio Unitario</label>
                        <input type="number" name="precio_unitario_matreq" id="modal_precio_unitario"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <form id="updateDepositoForm" method="POST"
                ...
                <div class="space-y-4">
                    <div>
                        <label for="banco_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Banco</label>
                        <input type="text" name="banco_req" id="modal_banco_req"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="nro_banco_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Número de Banco</label>
                        <input type="text" name="nro_banco_req" id="modal_nro_banco_req"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="cci_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">CCI</label>
                        <input type="text" name="cci_req" id="modal_cci_req"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        <label for="titular_req"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Titular</label>
                        <input type="text" name="titular_req" id="modal_titular_req"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                    <div>
                        ...
                        <input type="text" name="dni_req" id="modal_dni_req"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required>
                    </div>
                </div>
    ...
    @php
        ...
        // Verifica si el área laboral es 'Administracion' o 'Gerencia'
        $areaLaboral = auth()->user()->area_laboral ?? '';
        $canApproveAdmin = in_array($areaLaboral, ['Administracion', 'Gerencia']);
    @endphp

    <div class="py-2">
        <div class="max-w-full mx-auto px-1 sm:px-2 lg:px-4">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">N°
                                            Orden</label>
                                        <input type="text"
                                            value="E000{{ $requerimiento->numero_orden_requerimiento }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 text-center"
                                            disabled>
                                    </div>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Solicitante</label>
                                        <input type="text" value="{{ $requerimiento->solicitado_requerimiento }}"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Fecha
                                            Solicitado</label>
                                        <input type="text" value="{{ $requerimiento->fecha_requerimiento }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100" disabled>
                                    </div>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Correo</label>
                                        <input type="text" value="{{ $requerimiento->correo_requerimiento }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100" disabled>
                                    </div>
                                    <div>
                                        <label
                                            ...
                                            Requerimiento</label>
                                        <input type="text" value="{{ $requerimiento->nombre_requerimiento }}"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Proyecto</label>
                                        <input type="text" value="{{ $requerimiento->proyecto->nombre_proyecto }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100" disabled>
                                    </div>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Cargo</label>
                                        <input type="text" value="{{ $requerimiento->cargo_requerimiento }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100" disabled>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @foreach ($requerimiento->manoObra as $obra)
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                <td
                                                    ...
                                                    {{ $obra->id_mano_obra }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $obra->descripcion_manoobra }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $obra->cantidad_manoobra }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    S/{{ number_format($obra->precio_uni_manoobra, 2) }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                                    S/{{ number_format($montoTotal, 2) }}</td>
                                                @if ($canApproveAdmin)
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($requerimiento->materiales as $material)
                                            @php
                                                $montoTotalmat =
                                                    $material->cantidad_material_req *
                                                    $material->precio_unitario_matreq;
                                            @endphp
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $material->id_materiales_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $material->descripcion_material_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $material->unidad }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $material->cantidad_material_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    S/{{ number_format($material->precio_unitario_matreq, 2) }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                                    S/{{ number_format($montoTotalmat, 2) }}</td>
                                                @if ($canApproveAdmin)
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <div class="flex space-x-2">
                                                            <button
                    ...
                    @if ($montoTotal > 0)
                        <div class="bg-blue-50 dark:bg-blue-900 rounded-lg p-4 mb-8">
                            <div class="flex items-center justify-between">
                                <span class="text-lg font-semibold text-blue-900 dark:text-blue-100">Total del
                                    Requerimiento:</span>
                                <span
                                    class="text-2xl font-bold text-blue-900 dark:text-blue-100">S/{{ number_format($montoTotal, 2) }}</span>
                            </div>
                        </div>
                    @endif
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($requerimiento->depositos as $deposito)
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $deposito->id_depositoreq }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $deposito->banco_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-mono">
                                                    {{ $deposito->nro_banco_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-mono">
                                                    {{ $deposito->cci_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                    {{ $deposito->titular_req }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-mono">
                                                    {{ $deposito->dni_req }}</td>
                                                <td
                                                ...
                                                @if ($canApproveAdmin)
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <button onclick="openDepositoEditModal({{ $deposito }})"
                                                            class="text-indigo-600 hover:text-indigo-900">Editar</button>
                                                    </td>
                                                @endif
                                            </tr>
                    ...
                    @if ($canApproveAdmin)
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-8">
                            ...
                            <div class="flex justify-center gap-4">
                                ...
                                <button type="button" id="open_sustentoreque"
                                    class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:ring ring-green-300">
                                ...
                                <form
                                    ...
                                    <button type="submit"
                                        class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 active:bg-red-900 focus:outline-none focus:ring ring-red-300">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (
                        ...
                        <div class="bg-green-50 dark:bg-green-900 rounded-lg p-6">
                            ...
                            <div class="flex justify-center">
                                <button id="open_doc_sustentado"
                                    class="inline-flex items-center px-6 py-3 bg-green-600 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring ring-green-300">
    ...
    {{-- Modal Sustentación --}}
    <div id="sustentoRequerimientosModal"
        class="fixed inset-0 flex items-center justify-center z-50 hidden bg-black bg-opacity-50">
                    ...
                    <form action="{{ route('logistica.requerimientos.aprobar', $requerimiento->id_requerimiento) }}"
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Requerimiento</label>
                                    <input type="text" value="{{ $requerimiento->nombre_requerimiento }}"
                                ...
                                <div>
                                    <label
                                        ...
                                        Total</label>
                                    <input type="text" value="S/{{ number_format($montoTotal, 2) }}"
                                        class="w-full rounded-md border-gray-300 bg-gray-100" disabled>
                                </div>
                            </div>
                            <div>
                                <label for="sustento_requerimiento"
    ...
    <div id="documentoSustentadoModal"
        class="fixed w-full inset-0 flex items-center justify-center z-50 hidden bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-96 overflow-y-auto">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Requerimiento Sustentado</h2>
                <button type="button" id="dismiss_sustentadodoc" class="text-gray-400 hover:text-gray-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
            ...
            <div class="space-y-6">
                        ...
                        @if (in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg']))
                            <div class="text-center">
                                <img src="{{ asset('storage/sustento_requerimiento/' . $requerimiento->sustento_requerimiento) }}"
                                    alt="Sustento Requerimiento" class="max-w-full h-auto rounded-lg shadow-lg">
                            </div>
                        @elseif(strtolower($extension) == 'pdf')
                            <div class="text-center p-8 bg-red-50 rounded-lg">
                                <svg class="w-16 h-16 mx-auto text-red-600 mb-4" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @else
                    <div class="text-center p-8 bg-yellow-50 rounded-lg">
                        <svg class="w-16 h-16 mx-auto text-yellow-400 mb-4" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        function openModal(obra) {
            const idField = $id('modal_id_mano_obra');
            if (!idField) return;
            idField.value = obra.id_mano_obra;
            $id('modal_descripcion_manoobra').value = obra.descripcion_manoobra || '';
            $id('modal_cantidad_manoobra').value = obra.cantidad_manoobra || '';
        ...
        function openMaterialEditModal(material) {
            if (!$id('modal_id_materiales_req')) return;
            $id('modal_id_materiales_req').value = material.id_materiales_req;
            $id('modal_descripcion_material').value = material.descripcion_material_req || '';
            $id('modal_unidad').value = material.unidad || '';
            $id('modal_cantidad_material').value = material.cantidad_material_req || '';
            $id('modal_precio_unitario').value = material.precio_unitario_matreq || '';
        ...
        function openDepositoEditModal(deposito) {
            if (!$id('modal_id_depositoreq')) return;
            $id('modal_id_depositoreq').value = deposito.id_depositoreq;
            $id('modal_banco_req').value = deposito.banco_req || '';
            $id('modal_nro_banco_req').value = deposito.nro_banco_req || '';
            $id('modal_cci_req').value = deposito.cci_req || '';
            $id('modal_titular_req').value = deposito.titular_req || '';
            $id('modal_dni_req').value = deposito.dni_req || '';
        ...
        // Safely attach handlers for sustaining modals
        const openSustentoBtn = $id('open_sustentoreque');
        if (openSustentoBtn) {
            openSustentoBtn.addEventListener('click', function() {
                const modal = $id('sustentoRequerimientosModal');
                if (modal) modal.classList.remove('hidden');
            });
        }

        const dismissSustentoBtn = $id('dismiss_sustentoreque');
        if (dismissSustentoBtn) {
            dismissSustentoBtn.addEventListener('click', function() {
                const modal = $id('sustentoRequerimientosModal');
                if (modal) modal.classList.add('hidden');
            });
        }

        const openDocBtn = $id('open_doc_sustentado');
        if (openDocBtn) {
            openDocBtn.addEventListener('click', function() {
                const modal = $id('documentoSustentadoModal');
                if (modal) modal.classList.remove('hidden');
            });
        }

        const dismissDocBtn = $id('dismiss_sustentadodoc');
        if (dismissDocBtn) {
            dismissDocBtn.addEventListener('click', function() {
                const modal = $id('documentoSustentadoModal');
                if (modal) modal.classList.add('hidden');
            });
        }

        // Close modals when clicking outside (robust: check existence)
        window.addEventListener('click', function(event) {
            const modalIds = ['updateModal', 'updateMaterialModal', 'updateDepositoModal', 'sustentoRequerimientosModal', 'documentoSustentadoModal'];
