        ...
        <x-slot name="header">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <button @click="abrirModalPresupuestos" id="btn-presupuestos"
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105 shadow-lg">
                        <i class="fas fa-chart-pie mr-2"></i>
                        Presupuestos
                    </button>
                    {{-- <button @click="actualizarGastos" id="btn-actualizar-gastos"
                        :disabled="state.actualizandoGastos"
                        ...
                        <i :class="['mr-2', state.actualizandoGastos ? 'fas fa-spinner fa-spin' : 'fas fa-sync-alt']"></i>
                        <span>@{{ state.actualizandoGastos ? 'Actualizando...' : 'Actualizar Gastos' }}</span>
                    </button> --}}
                </div>
            </div>
        </x-slot>
