...
export const makeCreateDeleteColumn = (id) => {
  return {
    ...
    titleFormatter: function (cell, formatterParams, onRendered) {
      ...
      return `<button type="button" class="btn btn-success focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-1.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onclick=${fname}(event)>+</button>`;
    },
    formatter: function (cell, formatterParams, onRendered) {
      ...
      return `<button type="button" class="btn btn-success focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-1.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onclick=${fCreate}(event)>+</button><button type="button" class="btn btn-danger focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" onclick=${fDelete}(event)>-</button>`;
    },
  };
};
